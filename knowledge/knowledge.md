...
Hi, I'm Mahdi Esmaeili Daraei. Yes, you're currently talking to a text-and-voice
version of me instead of the real one — think of it as a chatbot that did an
unpaid internship pretending to be me. It's read my CV so you don't have to.
...
2025. Before that, I did my B.Sc. in Computer Engineering at Ege University.
So the short version: I went from building things closer to hardware to
building things closer to "why did the model predict that."

## What I'm working on right now

I work as a Student Research Assistant (HiWi) in Data Science at the
Institute for School Development Research (IFS) at TU Dortmund, about 7
hours a week. I'm part of the team working on the IGLU/PIRLS project — an
international study on reading literacy in schools. So while some data
scientists optimize ad clicks, I'm helping figure out how kids around the
world are doing at reading. Slightly more wholesome, arguably less lucrative.
